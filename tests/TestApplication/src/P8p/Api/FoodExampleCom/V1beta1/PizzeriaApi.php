...
namespace P8p\Bundle\Tests\TestApplication\P8p\Api\FoodExampleCom\V1beta1;

use P8p\Bundle\Tests\TestApplication\P8p\Schema\FoodExampleCom\V1beta1\Pizzeria;
use P8p\Bundle\Tests\TestApplication\P8p\Schema\FoodExampleCom\V1beta1\PizzeriaList;
...
class PizzeriaApi extends AbstractApi
{
    ...
    public function list(string $namespace, array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            verb: 'GET',
            path: '/apis/food.example.com/v1beta1/namespaces/{namespace}/pizzerias',
    ...
    public function read(string $name, string $namespace, array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            verb: 'GET',
            path: '/apis/food.example.com/v1beta1/namespaces/{namespace}/pizzerias/{name}',
    ...
    public function listForAllNamespaces(array $queryParameters = []): Response
    {
        return $this->client->makeRequest(
            verb: 'GET',
            path: '/apis/food.example.com/v1beta1/pizzerias',
            responseClass: PizzeriaList::class,
            queryParameters: $queryParameters,
        );
    }
